...
const Cart = () => {
  ...
  if (isEmpty)
    return (
      <h5 className="body text-center text-second py-3">
  ...
  return (
    <div className="body container-fluid py-5">
      <div className="body row justify-content-center">
        <h4 className="text text-center py-3 text-decoration-underline">
          La Mia Carta
        </h4>
        <div className="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 py-4">
          <div className="d-flex justify-content-center py-3">
            <p className="text-second position-relative fw-bolder text-title">
              Shopping cart{" "}
              <span className="postition-absolute translate-middle rounded-pill badge bg-danger mx-1">
                {totalUniqueItems}
              </span>
            </p>
            <p className="text-second fw-bolder text-title">
              Total items{" "}
